...
// ═══════════════════════════════════════════════════════════════════
// היום — the schedule on top, the task bank under it
// ═══════════════════════════════════════════════════════════════════
// Owns the data for both halves, because they are two views of one set of
// rows: the bank lists tasks, the calendar shows the ones carrying a
// task_time. Placing writes those columns on the task itself — nothing is
