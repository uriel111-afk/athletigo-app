...
export default function Layout({ children, currentPageName }) {
  ...
  const coachNavItems = [
    ...
    // ── כלים ──
    { title: "רווחיות", url: createPageUrl("Profitability"), icon: Calculator, section: "content" },
        ...
        <aside className={`${isFullScreen ? 'hidden' : 'hidden md:flex'} flex-col w-64 p-6`} style={{
          ...
          <div className="mb-8 p-4 rounded-2xl" style={{
            ...
            <div className="flex items-center gap-3 justify-center">
              ...
              />
              <div>
                <h2 className="font-bold font-display" style={{ color: '#000000', fontSize: 20, letterSpacing: '1.5px' }}>ATHLETIGO</h2>
