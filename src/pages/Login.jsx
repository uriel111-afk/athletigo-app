      ...
      <div className="w-full" style={{ maxWidth: 400, margin: '0 auto', marginTop: 8, flexShrink: 0 }}>
        <div style={{
          ...
          <div style={{ textAlign: 'right' }}>
            <div style={{ fontSize: 24, fontWeight: 600, color: '#111', lineHeight: 1.25 }}>ברוכים הבאים 👋</div>
            <div style={{ fontSize: 15, fontWeight: 500, color: '#888' }}>כניסה למאמנים ומתאמנים</div>
          </div>
          ...
          <img
            src="/logoR.png"
            alt="AthletiGo"
            style={{ width: 106, height: 'auto', objectFit: 'contain', flexShrink: 0, filter: 'brightness(0)' }}
          />
        </div>
      </div>
