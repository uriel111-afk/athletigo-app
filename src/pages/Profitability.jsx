...
export default function Profitability() {
  ...
  return (
    <div dir="rtl" style={{ background: 'var(--ag-bg)', minHeight: '100vh', fontFamily: "'Heebo', sans-serif" }}>
      <div style={{ maxWidth: 640, margin: '0 auto', padding: '16px 14px 120px' }}>
        ...
        <div style={{ display: 'flex', gap: 6, background: 'var(--ag-card-bg)', borderRadius: 12, padding: 4, marginBottom: 16, boxShadow: 'var(--ag-card-shadow)' }}>
          {TABS.map((t) => (
            <button key={t.k} onClick={() => setTab(t.k)} style={{
              flex: 1, padding: '11px 0', borderRadius: 10, fontSize: 16, fontWeight: 800, cursor: 'pointer', fontFamily: 'inherit',
